...
| Conference | Date | Venue | Description |Mode|
|------------|------|-------|-------------|----|
|[AWS Summit London 2025](https://aws.amazon.com/events/summits/london/)|April 30 |ExCeL London|The summit featured generative AI, serverless computing, and cloud security discussions, with breakout sessions, workshops, and networking opportunities for the cloud computing community.|offline|
|[Google Cloud London Summit '25](https://cloudonair.withgoogle.com/events/london-summit-25)| 9th July |11 St Giles Place London SW1W 9TQ United Kingdom |latest technological innovations in generative AI, security, data, application development, collaboration, sustainability, industry trends and more.|offline|
|[MCPconference London](https://luma.com/mcpconference)|Thursday 24 July|93 Feet East,150 Brick Ln, London E1 6QL|Europe’s first developer conference dedicated to the Model Context Protocol (MCP). Bringing together engineers, toolmakers, and contributors for a one-day event focused on MCP — the open standard for connecting AI systems to tools, APIs, and data.|offline|
|[Civo Navigate London 2025](https://www.civo.com/navigate/london/2025)|Tuesday, 30th September |Convene 155 Bishopsgate in London|Civo Navigate London: Sovereignty and AI Edition|offline|
| [MongoDB.local London](https://www.mongodb.com/events/mongodb-local/london/) | Tuesday, 7 October | Hilton London Metropole | MongoDB.local London — including technical deep dives, hands-on learning, and real-world use cases |offline|
|[ObservabilityCON 2025](https://grafana.com/events/observabilitycon/)|Tuesday 7th October|Sancroft, Rose St, Paternoster Sq. London , EC4M 7DQ , United Kingdom|ObservabilityCON 2025 with the latest in AI-powered observability in Grafana Cloud. Learn how we’re evolving our open observability cloud to help teams detect, understand, and act faster. At Grafana Labs, open has always been our strategy: open source, open standards, open data, and open minds. As complexity grows and AI reshapes how teams build and operate software, learn how that open strategy is helping organizations get value from their telemetry and turn signals into action – and observability into competitive advantage.|offline|
...
` | [name-of-conf](link) | date | venue | description| mode |`
